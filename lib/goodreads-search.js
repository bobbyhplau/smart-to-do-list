...
const toRead = function(book) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    promise.then(function(result) {
        ...
        console.log(result.search['results-end']);
        ...
        let title = result.search.results.work[0].best_book.title;
        ...
        const ratingsCount = result.search.results.work[0].ratings_count._;
